...
class Octree:
    ...
    def visualize(self, plotter: Plotter, title: str, num_slices=8, z_start=30, z_end=120):
        ...
        plotter.plot_irradiance_slices(grid, title, threshold=self.threshold, num_slices=num_slices, z_start=z_start, z_end=z_end)
